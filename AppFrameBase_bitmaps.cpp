...
void wxC2843InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/AppFrameBase_bitmaps.cpp$C__Dev_Work_Projects_Desktop_Templates_AppFrameBase_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/AppFrameBase_bitmaps.cpp$C__Dev_Work_Projects_Desktop_Templates_AppFrameBase_bitmaps.xrc"));
}
